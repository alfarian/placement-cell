  ...
  <div class="col-md-12">
    <card>
      <template slot="header">
        <h4 class="card-title">Placement Cell Headings</h4>
      ...
      <div class="content">
        <div class="typo-line">
          <h1>
            <p class="category">Header 1</p>Placement Cell Heading </h1>
        </div>
        <div class="typo-line">
          <h2>
            <p class="category">Header 2</p>Placement Cell Heading </h2>
        </div>
        <div class="typo-line">
          <h3>
            <p class="category">Header 3</p>Placement Cell Heading </h3>
        </div>
        <div class="typo-line">
          <h4>
            <p class="category">Header 4</p>Placement Cell Heading </h4>
        </div>
        <div class="typo-line">
          <h5>
            <p class="category">Header 5</p>Placement Cell Heading </h5>
        </div>
        <div class="typo-line">
          <h6>
            <p class="category">Header 6</p>Placement Cell Heading </h6>
        </div>
        <div class="typo-line">
          <p>
